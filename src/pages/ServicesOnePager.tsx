  ...
  return <div className="min-h-screen bg-background p-6 px-[36px] mx-0">
      ...
      aspectRatio: "8.5/11"
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          {services.map(service => <div key={service.id} className="border border-border rounded-lg p-4">
              ...
              <ul className="text-xs space-y-1 mb-2">
                {service.benefits.slice(0, 2).map((benefit, idx) => <li key={idx} className="flex items-start gap-2">
