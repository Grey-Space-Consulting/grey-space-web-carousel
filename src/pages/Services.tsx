...
import { Building, ChevronRight, Cog, Globe, Lightbulb, Users, Check } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-fade-in mb-24" style={{ animationDelay: "200ms" }}>
